...
# Name: archConfigLaptop
# ID: 784ba821-f925-41c0-b7c2-c8379ed65e09
...
echo -e "Name: archConfigLaptop"
echo -e "ID: 784ba821-f925-41c0-b7c2-c8379ed65e09"
echo -e "Description: A spell to configure a new Arch instance"
echo -e "Identity: topherludlow@protonmail.com"
echo -e "Converging 76 resources..."
converge=''
cycle=0
converged="$(printf "\xE2\x98\xB1%.0s "  $(seq 76))"
echo -en "\033[0m"

while [ "$converge" != "$converged" ] && [ $cycle -le 76 ]
  do
    converge=''
    ...
    then
      ...
      echo -en "\033[0m"
      u_out=$(su - topher -c 'mkdir -p /home/topher/.config && curl archfiles.topherludlow.com/Configs/.config/user-dirs.dirs > ~/.config/user-dirs.dirs')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
...
migrateold=false" > ~/.config/user-dirs.conf')
    ...
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 NetworkManager.service should be enabled"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 NetworkManager.service should be enabled"
      echo -en "\033[0m"
      u_out=$(systemctl enable NetworkManager.service)
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 .Xresources should exist"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 .Xresources should exist"
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl archfiles.topherludlow.com/Configs/Xresources > /home/topher/.Xresources')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 Network Manager should be installed"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 Network Manager should be installed"
      echo -en "\033[0m"
      u_out=$(pacman -S networkmanager --noconfirm)
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    if (pacman -Q scrot > /dev/null)
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 scrot should be installed"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 scrot should be installed"
      echo -en "\033[0m"
      u_out=$(pacman -S scrot --noconfirm)
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      ...
      echo -en "\033[0m"
      u_out=$(useradd -m -G wheel -p '$6$fx0yL9LuJDIaOXvx$ZaSShw8isgHGZ7L2oq8lPnYipHLsKZAI4CtGMi.3kWHp94CqhBzAk5X0986nTOLQP5xuQg4jbB7MTbG/WETJP1' topher && chown -R topher:topher /home/topher)
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 i3 config should exist"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 i3 config should exist"
      echo -en "\033[0m"
      u_out=$(su - topher -c 'mkdir -p /home/topher/.config/i3 && curl archfiles.topherludlow.com/Configs/.config/i3/config > /home/topher/.config/i3/config')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    if (systemctl is-active NetworkManager.service > /dev/null)
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 NetworkManager.service should be started"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 NetworkManager.service should be started"
      echo -en "\033[0m"
      u_out=$(systemctl start NetworkManager.service)
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 .gitconfig should exist"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 .gitconfig should exist"
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl archfiles.topherludlow.com/Configs/gitconfig > /home/topher/.gitconfig')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 .bash_profile should exist"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 .bash_profile should exist"
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl archfiles.topherludlow.com/Configs/bash_profile > /home/topher/.bash_profile')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    if (grep -q "^HOOKS=.*[[:space:]]resume[[:space:]]" /etc/mkinitcpio.conf > /dev/null)
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 resume should be set in mkinitcpio.conf"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 resume should be set in mkinitcpio.conf"
      echo -en "\033[0m"
      u_out=$(sed -i 's/\(^HOOKS=([^)]*filesystems\) \(fsck\)/\1 resume \2/' /etc/mkinitcpio.conf && mkinitcpio -P)
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 .xinitrc should exist"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 .xinitrc should exist"
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl archfiles.topherludlow.com/Configs/xinitrc > /home/topher/.xinitrc')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 .bashrc should exist"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 .bashrc should exist"
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl archfiles.topherludlow.com/Configs/bashrc > /home/topher/.bashrc')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    if (grep -q "^HandleSuspendKey=" /etc/systemd/logind.conf > /dev/null)
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 HandleSuspendKey should be uncommented in logind.conf"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 HandleSuspendKey should be uncommented in logind.conf"
      echo -en "\033[0m"
      u_out=$(sed -i 's/^#HandleSuspendKey=suspend/HandleSuspendKey=hibernate/' /etc/systemd/logind.conf)
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
...
" | tee -a /etc/hosts)
    ...
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 .vimrc should exist"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 .vimrc should exist"
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl archfiles.topherludlow.com/Configs/vimrc > /home/topher/.vimrc')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      ...
      echo -en "\033[0m"
      u_out=$(grub-install --target=x86_64-efi --efi-directory=/boot --bootloader-id=Arch && grub-mkconfig -o /boot/grub/grub.cfg)
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 i3blocks config should exist"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 i3blocks config should exist"
      echo -en "\033[0m"
      u_out=$(su - topher -c 'mkdir -p /home/topher/.config/i3blocks && curl archfiles.topherludlow.com/Configs/.config/i3blocks/config > /home/topher/.config/i3blocks/config')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
...
end_time="$(date -u +%s)"
  ...
  echo -en "\033[1;33m"
  echo -e "* The Spellcaster free tier includes up to 10 trigraphs. You are at 76 trigraphs and should sign up for an individual plan here https://spellcaster.sh/pricing.\n"
  echo -en "\033[0m"
