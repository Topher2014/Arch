...
# Name: archConfig
# ID: 1972d5fb-94bc-41a6-99d7-fba031de6f4e
...
echo -e "ID: 1972d5fb-94bc-41a6-99d7-fba031de6f4e"
echo -e "Description: A spell to configure a new Arch instance"
echo -e "Identity: topherludlow@protonmail.com"
echo -e "Converging 72 resources..."
converge=''
cycle=0
converged="$(printf "\xE2\x98\xB1%.0s "  $(seq 72))"
echo -en "\033[0m"

while [ "$converge" != "$converged" ] && [ $cycle -le 72 ]
  do
    converge=''
...
migrateold=false" > ~/.config/user-dirs.conf')
    ...
    if (grep -q "192.168.88.51:/share/desktop" /proc/mounts > /dev/null)
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 NAS drive should be mounted to Desktop"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 NAS drive should be mounted to Desktop"
      echo -en "\033[0m"
      u_out=$(mount 192.168.88.51:/share/desktop /home/topher/Desktop/ && genfstab -U /)
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
...
end_time="$(date -u +%s)"
  ...
  echo -en "\033[1;33m"
  echo -e "* The Spellcaster free tier includes up to 10 trigraphs. You are at 72 trigraphs and should sign up for an individual plan here https://spellcaster.sh/pricing.\n"
  echo -en "\033[0m"
