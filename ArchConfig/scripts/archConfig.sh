...
# Name: archConfig
# ID: ff376e38-de26-438a-b0a7-ed445da474b3
...
echo -e "ID: ff376e38-de26-438a-b0a7-ed445da474b3"
echo -e "Description: A spell to configure a new Arch instance"
echo -e "Identity: topherludlow@protonmail.com"
echo -e "Converging 67 resources..."
converge=''
cycle=0
converged="$(printf "\xE2\x98\xB1%.0s "  $(seq 67))"
echo -en "\033[0m"

while [ "$converge" != "$converged" ] && [ $cycle -le 67 ]
  do
    converge=''
    ...
    then
      ...
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl https://raw.githubusercontent.com/Topher2014/Arch/refs/heads/main/ConfigFiles/home/topher/.bash_profile >> /home/topher/.bash_profile')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
...
" | tee -a /etc/hosts)
    ...
    then
      ...
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl https://raw.githubusercontent.com/Topher2014/Arch/refs/heads/main/ConfigFiles/home/topher/.Xresources >> /home/topher/.Xresources')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      ...
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl https://raw.githubusercontent.com/Topher2014/Arch/refs/heads/main/ConfigFiles/home/topher/.vimrc >> /home/topher/.vimrc')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      ...
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl https://raw.githubusercontent.com/Topher2014/Arch/refs/heads/main/ConfigFiles/home/topher/.bashrc >> /home/topher/.bashrc')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
...
migrateold=false" > ~/.config/user-dirs.conf')
    ...
    then
      ...
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl https://raw.githubusercontent.com/Topher2014/Arch/refs/heads/main/ConfigFiles/home/topher/.gitconfig >> /home/topher/.gitconfig')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
    ...
    then
      ...
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl https://raw.githubusercontent.com/Topher2014/Arch/refs/heads/main/ConfigFiles/home/topher/.xinitrc >> /home/topher/.xinitrc')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
...
end_time="$(date -u +%s)"
  ...
  echo -en "\033[1;33m"
  echo -e "* The Spellcaster free tier includes up to 10 trigraphs. You are at 67 trigraphs and should sign up for an individual plan here https://spellcaster.sh/pricing.\n"
  echo -en "\033[0m"
