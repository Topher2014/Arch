...
# Name: archConfig
# ID: 44234d16-89d6-4291-8f65-37c685ab14aa
...
echo -e "ID: 44234d16-89d6-4291-8f65-37c685ab14aa"
echo -e "Description: A spell to configure a new Arch instance"
echo -e "Identity: topherludlow@protonmail.com"
echo -e "Converging 68 resources..."
converge=''
cycle=0
converged="$(printf "\xE2\x98\xB1%.0s "  $(seq 68))"
echo -en "\033[0m"

while [ "$converge" != "$converged" ] && [ $cycle -le 68 ]
  do
    converge=''
    ...
    if (test -d /home/topher/Desktop/Configs > /dev/null)
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 Config files should exist"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 Config files should exist"
      echo -en "\033[0m"
      u_out=$(su - topher -c 'curl -L https://github.com/Topher2014/Arch/archive/refs/heads/main.zip -o ~/Arch.zip && mkdir -p ~/Desktop && cd ~/ && unzip Arch.zip "Arch-main/ConfigFiles/Configs/*" -d ~/Desktop/ && mv ~/Desktop/Arch-main/ConfigFiles/Configs ~/Desktop/ && rm -rf ~/Desktop/Arch-main ~/Arch.zip')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
...
" | tee -a /etc/hosts)
    ...
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 Screenshots, Downloads, and Documents directories should exist"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 Screenshots, Downloads, and Documents directories should exist"
      echo -en "\033[0m"
...
end_time="$(date -u +%s)"
  ...
  echo -en "\033[1;33m"
  echo -e "* The Spellcaster free tier includes up to 10 trigraphs. You are at 68 trigraphs and should sign up for an individual plan here https://spellcaster.sh/pricing.\n"
  echo -en "\033[0m"
