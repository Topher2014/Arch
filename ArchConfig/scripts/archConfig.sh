...
# Name: archConfig
# ID: af7a2253-421e-4b4a-b920-017328a5a1a4
...
echo -e "ID: af7a2253-421e-4b4a-b920-017328a5a1a4"
echo -e "Description: A spell to configure a new Arch instance"
echo -e "Identity: topherludlow@protonmail.com"
echo -e "Converging 69 resources..."
converge=''
cycle=0
converged="$(printf "\xE2\x98\xB1%.0s "  $(seq 69))"
echo -en "\033[0m"

while [ "$converge" != "$converged" ] && [ $cycle -le 69 ]
  do
    converge=''
...
end_time="$(date -u +%s)"
  ...
  echo -en "\033[1;33m"
  echo -e "* The Spellcaster free tier includes up to 10 trigraphs. You are at 69 trigraphs and should sign up for an individual plan here https://spellcaster.sh/pricing.\n"
  echo -en "\033[0m"
