...
# Name: archConfig
# ID: 5cb87882-ca8a-46be-a7fe-ec9574fb1c69
...
echo -e "ID: 5cb87882-ca8a-46be-a7fe-ec9574fb1c69"
echo -e "Description: A spell to configure a new Arch instance"
echo -e "Identity: topherludlow@protonmail.com"
echo -e "Converging 71 resources..."
converge=''
cycle=0
converged="$(printf "\xE2\x98\xB1%.0s "  $(seq 71))"
echo -en "\033[0m"

while [ "$converge" != "$converged" ] && [ $cycle -le 71 ]
  do
    converge=''
...
migrateold=false" > ~/.config/user-dirs.conf')
    ...
    if (test -d /home/topher/Desktop > /dev/null)
    then
      c_exit=0
      echo -en "\033[0;32m"
      echo -e "  \xE2\x9C\x93 Desktop directory exist"
      echo -en "\033[0m"
      u_exit=1
    else
      c_exit=1
      echo -en "\033[0;31m"
      echo -e "  \xE2\x9C\x97 Desktop directory exist"
      echo -en "\033[0m"
      u_out=$(su - topher -c 'mkdir /home/topher/Desktop')
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
...
" | tee -a /etc/hosts)
    ...
    then
      ...
      echo -en "\033[0m"
      u_out=$(mount 192.168.88.51:/share/desktop /home/topher/Desktop/ && genfstab -U / > /etc/fstab && chown topher:topher /home/topher/Desktop)
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
...
end_time="$(date -u +%s)"
  ...
  echo -en "\033[1;33m"
  echo -e "* The Spellcaster free tier includes up to 10 trigraphs. You are at 71 trigraphs and should sign up for an individual plan here https://spellcaster.sh/pricing.\n"
  echo -en "\033[0m"
