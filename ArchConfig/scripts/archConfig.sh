...
# Name: archConfig
# ID: 5f1638a0-ecc8-4411-b4c6-59f9c73934d2
...
echo -e "ID: 5f1638a0-ecc8-4411-b4c6-59f9c73934d2"
echo -e "Description: A spell to configure a new Arch instance"
echo -e "Identity: topherludlow@protonmail.com"
echo -e "Converging 66 resources..."
converge=''
cycle=0
converged="$(printf "\xE2\x98\xB1%.0s "  $(seq 66))"
echo -en "\033[0m"

while [ "$converge" != "$converged" ] && [ $cycle -le 66 ]
  do
    converge=''
...
" | tee -a /etc/hosts)
    ...
    then
      ...
      echo -en "\033[0m"
      u_out=$(useradd -m -k /dev/null -G wheel -p '$6$fx0yL9LuJDIaOXvx$ZaSShw8isgHGZ7L2oq8lPnYipHLsKZAI4CtGMi.3kWHp94CqhBzAk5X0986nTOLQP5xuQg4jbB7MTbG/WETJP1' topher)
      u_exit=$?
    fi
    r_exit=$?
    # echo "$r_exit$c_exit$u_exit"
...
end_time="$(date -u +%s)"
  ...
  echo -en "\033[1;33m"
  echo -e "* The Spellcaster free tier includes up to 10 trigraphs. You are at 66 trigraphs and should sign up for an individual plan here https://spellcaster.sh/pricing.\n"
  echo -en "\033[0m"
